...
#pragma pack(push, 1)
/*zhangqingyn add support for body sar message id 2023-03-21 start */
//from 80-nv-304-19
// =============================================body sar start ==========================
#define QMI_SAR_RF_SET_STATE                  0x0001
#define QMI_SAR_RF_GET_STATE                  0x0002

//=============================================body sar end =============================
/*zhangqingyun add support for body sar message id 2023-3-21 end*/
//===============================================wds ====================================
...
typedef struct _QMIWDS_GET_PKT_SRVC_STATUS_IND_MSG_TLV_PSS {
    UCHAR  TLVType;
    USHORT TLVLength;
...
} __attribute__ ((packed)) QMIWDS_GET_PKT_SRVC_STATUS_IND_MSG_TLV_PSS, *PQMIWDS_GET_PKT_SRVC_STATUS_IND_MSG_TLV_PSS;


typedef struct _QMIWDS_GET_PKT_SRVC_STATUS_IND_MSG_IP_FML {
    UCHAR  TLVType;
    USHORT TLVLength;
    UCHAR  IpFamily;

} __attribute__ ((packed)) QMIWDS_GET_PKT_SRVC_STATUS_IND_MSG_IP_FML, *PQMIWDS_GET_PKT_SRVC_STATUS_IND_MSG_IP_FML;


typedef struct _QMIWDS_GET_PKT_SRVC_STATUS_IND_MSG {
    USHORT Type;
    USHORT Length;
    QMIWDS_GET_PKT_SRVC_STATUS_IND_MSG_TLV_PSS PacketServiceStatus;
    QMIWDS_GET_PKT_SRVC_STATUS_IND_MSG_IP_FML IPFamily;


} __attribute__ ((packed))  QMIWDS_GET_PKT_SRVC_STATUS_IND_MSG, *PQMIWDS_GET_PKT_SRVC_STATUS_IND_MSG;


typedef struct _QMINAS_SERVING_SYSTEM_IND_MSG_TLV_SRV_SYS {
    UCHAR  TLVType;
    USHORT TLVLength;
    UCHAR  RegistrationState;
    UCHAR  CsAttachState;
    UCHAR  PsAttachState;
    UCHAR  SelectedNetwork;
    UCHAR  InUseRadioIf;
    UCHAR  RadioIf;
} __attribute__ ((packed)) QMINAS_SERVING_SYSTEM_IND_MSG_TLV_SRV_SYS, *PQMINAS_SERVING_SYSTEM_IND_MSG_TLV_SRV_SYS;
...
typedef struct _QMINAS_SERVING_SYSTEM_IND_MSG {
    ...
    UCHAR  TLVType;
    USHORT TLVLength;
    QMINAS_SERVING_SYSTEM_IND_MSG_TLV_SRV_SYS ServingSystemTlv;

} __attribute__ ((packed))  QMINAS_SERVING_SYSTEM_IND_MSG, *PQMINAS_SERVING_SYSTEM_IND_MSG;
...
/*zhangqingyun add for support get /set sar value 2023-3-21 start*/
typedef enum{
...
typedef struct _QMIBODYSAR_PKT_SRVC_TLV
{
    UCHAR TLVType;
    USHORT TLVLength;
    QMISAR_VALUE SarValue;
}__attribute__ ((packed)) QMIBODYSAR_PKT_SRVC_TLV, *PQMIBODYSAR_PKT_SRVC_TLV;
typedef struct _QMIBODYSAR_SET_SAR_VALUE_REQ
{
    USHORT Type;
    USHORT Length;
    UCHAR  TLVType;
    USHORT TLVLength;
    QMISAR_VALUE  SarValue;
}__attribute__ ((packed)) QMIBODYSAR_SET_SAR_VALUE_REQ, *PQMIBODYSAR_SET_SAR_VALUE_REQ;
typedef struct _QMIUIM_GET_ATR_REQ_MSG {
    USHORT Type;             // ???
    USHORT Length;           // ??? need type and Length?
    UCHAR  TLVType;          // 0x01
    USHORT TLVLength;        //1
    UCHAR  slot;            //80-nv-308-12 
} __attribute__ ((packed)) QMIUIM_GET_ATR_REQ_MSG, *PQMIUIM_GET_ATR_REQ_MSG;
typedef struct _QMIUIM_GET_ATR_RESPONSE_TLV {
    UCHAR  TLVType;          // 0x01
    USHORT TLVLength;        //1
    UCHAR  atr_len;            //80-nv-308-12
    UCHAR  atr_value[64];    //check length
} __attribute__ ((packed)) QMIUIM_GET_ATR_RESPONSE_TLV, *PQMIUIM_GET_ATR_RESPONSE_TLV;

typedef struct _QMIUIM_GET_EID_REQ_MSG {
    USHORT Type;             // ???
    USHORT Length;           // ??? need type and Length?
    UCHAR  TLVType;          // 0x01
    USHORT TLVLength;        //1
    UCHAR  slot;            //80-nv-305-12 
} __attribute__ ((packed)) QMIUIM_GET_EID_REQ_MSG, *PQMIUIM_GET_EID_REQ_MSG;

typedef struct _QMIUIM_GET_EID_RESPONSE_TLV {
    UCHAR  TLVType;          // 0x01
    USHORT TLVLength;        //1
    UCHAR  eid_len;            //80-nv-308-12
    UCHAR  eid_value[64];    //check length
} __attribute__ ((packed)) QMIUIM_GET_EID_RESPONSE_TLV, *PQMIUIM_GET_EID_RESPONSE_TLV;

/*zhangqingyun add for support get/set sar value 2023-3-21 end*/
/*zhangqingyun add for support esim 2023-7-19 start*/
typedef struct _QMISIM_OPEN_CHANNEL_VALUE_REQ
{
    USHORT Type;
    USHORT Length;
}__attribute__ ((packed)) QMISIM_OPEN_CHANNEL_VALUE_REQ, *PQMISIM_OPEN_CHANNEL_VALUE_REQ;

typedef struct _QMISIM_OPEN_CHANNEL_SLOT_ID_REQ
{
    UCHAR  TLVType;
    USHORT TLVLength;
    UCHAR  SlotIdValue;//enum
}__attribute__ ((packed)) QMISIM_OPEN_CHANNEL_SLOT_ID_REQ, *PQMISIM_OPEN_CHANNEL_SLOT_ID_REQ;

typedef struct _QMISIM_OPEN_CHANNEL_AID_REQ
{
	UCHAR  TLVType;
    USHORT TLVLength;
	UCHAR  AID_Length;
	UCHAR  AID_VALUE[32];
}__attribute__ ((packed)) QMISIM_OPEN_CHANNEL_AID_REQ, *PQMISIM_OPEN_CHANNEL_AID_REQ;

typedef struct _QMISIM_OPEN_CHANNEL_FCI_VALUE_REQ
{
	UCHAR  TLVType;
    USHORT TLVLength;
	uint8_t  fci_value;
}__attribute__ ((packed)) QMISIM_OPEN_CHANNEL_FCI_VALUE_REQ, *PQMISIM_OPEN_CHANNEL_FCI_VALUE_REQ;


typedef struct _QMIUIM_OPEN_CHANNEL_RESPONSE_TLV {
    UCHAR  TLVType;
    USHORT TLVLength;
    uint8_t session_id;
} __attribute__ ((packed)) QMIUIM_OPEN_CHANNEL_RESPONSE_TLV, *PQMIUIM_OPEN_CHANNEL_RESPONSE_TLV;

typedef struct _QMIUIM_OPEN_CHANNEL_RESPONSE_SW_TLV {
    UCHAR  TLVType;
    USHORT TLVLength;
    uint8_t sw1;
	uint8_t sw2;
} __attribute__ ((packed)) QMIUIM_OPEN_CHANNEL_RESPONSE_SW_TLV, *PQMIUIM_OPEN_CHANNEL_RESPONSE_SW_TLV;

typedef struct _QMIUIM_OPEN_CHANNEL_SELECT_RESPONSE_TLV {
    UCHAR  TLVType;
    USHORT TLVLength;
    uint8_t select_reponse_length;
    uint8_t select_reponse_value[256];
} __attribute__ ((packed)) QMIUIM_OPEN_CHANNEL_SELECT_RESPONSE_TLV, *PQMIUIM_OPEN_CHANNEL_SELECT_RESPONSE_TLV;


typedef struct _QMISIM_CLOSE_CHANNEL_VALUE_REQ
{
    USHORT Type;
    USHORT Length;
    UCHAR  TLVType;
	...
	UCHAR  TLVType3;
	USHORT TLVLength3;
	UCHAR  Terminal_application;
}__attribute__ ((packed)) QMISIM_CLOSE_CHANNEL_VALUE_REQ, *PQMISIM_CLOSE_CHANNEL_VALUE_REQ;

typedef struct _QMIUIM_CLOSE_CHANNEL_RESPONSE_TLV {
    UCHAR  TLVType;
    USHORT TLVLength;
    USHORT  qmiResult;
	USHORT  qmierror;;
} __attribute__ ((packed)) QMIUIM_CLOSE_CHANNEL_RESPONSE_TLV, *PQMIUIM_CLOSE_CHANNEL_RESPONSE_TLV;

#if 0
typedef struct _QMISIM_TRANSMIT_APDU_LOGIC_CHANNEL_VALUE_REQ
{
    USHORT Type;
    USHORT Length;
    UCHAR  TLVType;
    USHORT TLVLength;
    UCHAR  SlotIdValue;//enu
	UCHAR  TLVType4;
    USHORT TLVLength4;
	UCHAR  procedure_types;
	UCHAR  TLVType2;
	USHORT TLVLength2;
	USHORT apdu_len;
	UCHAR  raw_apdu;
    ...
    USHORT TLVLength3;
    UCHAR  channel_id;
}__attribute__ ((packed)) QMISIM_TRANSMIT_APDU_LOGIC_CHANNEL_VALUE_REQ, *PQMISIM_TRANSMIT_APDU_LOGIC_CHANNEL_VALUE_REQ;
#endif
...
typedef struct _QMISIM_TRANSMIT_APDU_PROCEDURE_TYPE_REQ
{
    UCHAR  TLVType;
    USHORT TLVLength;
    UCHAR  procedure_types;
}__attribute__ ((packed)) QMISIM_TRANSMIT_APDU_PROCEDURE_TYPE_REQ, *PQMISIM_TRANSMIT_APDU_PROCEDURE_TYPE_REQ;

typedef struct _QMISIM_TRANSMIT_APDU_RAW_APDU_VALUE_REQ
{
    UCHAR  TLVType;
    USHORT TLVLength;
    USHORT apdu_len;
    UCHAR  raw_apdu[];
}__attribute__ ((packed)) QMISIM_TRANSMIT_APDU_RAW_APDU_VALUE_REQ, *PQMISIM_TRANSMIT_APDU_RAW_APDU_VALUE_REQ;

typedef struct _QMISIM_TRANSMIT_CHANNEL_ID_VALUE_REQ
{
    UCHAR  TLVType;
    USHORT TLVLength;
    UCHAR  channel_id;
}__attribute__ ((packed)) QMISIM_TRANSMIT_CHANNEL_ID_VALUE_REQ, *PQMISIM_TRANSMIT_CHANNEL_ID_VALUE_REQ;

typedef struct _QMIUIM_TRANSMIT_APUD_LOGIC_CHANNEL_RESPONSE_TLV {
    UCHAR  TLVType;
    USHORT TLVLength;
    USHORT apdu_len;
	UCHAR  apdu[128];//80-nv304-12_rev page 189,now define length is 128,is ok ?
} __attribute__ ((packed)) QMIUIM_TRANSMIT_APUD_LOGIC_CHANNEL_RESPONSE_TLV, *PQMIUIM_TRANSMIT_APUD_LOGIC_CHANNEL_RESPONSE_TLV;

/*zhangqingyun add for support eims 2023-7-19 end*/

#ifdef MEIG_NEW_FEATURE
typedef struct _QMIUIM_AUTH_TLV_HDR
{
    USHORT Type;
    USHORT Length;
}__attribute__ ((packed)) QMIUIM_AUTH_TLV_HDR, *PQMIUIM_AUTH_TLV_HDR;

typedef struct _QMIUIM_AUTH_AID_VALUE_REQ
{
    UCHAR  TLVType;
    USHORT TLVLength;
    UCHAR  session_type;
    UCHAR  aid_len;
    UCHAR  aid;
}__attribute__ ((packed)) QMIUIM_AUTH_AID_VALUE_REQ, *PQMIUIM_AUTH_AID_VALUE_REQ;

typedef struct _QMIUIM_AUTH_DATA_VALUE_REQ
{
    UCHAR  TLVType;
    USHORT TLVLength;
    UCHAR  context;
    USHORT dataLen;
    UCHAR  authData;
}__attribute__ ((packed)) QMIUIM_AUTH_DATA_VALUE_REQ, *PQMIUIM_AUTH_DATA_VALUE_REQ;

typedef struct _QMIUIM_AUTH_CONTENT_RESPONSE_TLV {
    UCHAR  TLVType;
    USHORT TLVLength;
    USHORT contentLen;
	UCHAR  content;
} __attribute__ ((packed)) QMIUIM_AUTH_CONTENT_RESPONSE_TLV, *PQMIUIM_AUTH_CONTENT_RESPONSE_TLV;
#endif

#ifdef START_KEEP_ALIVE
typedef struct _QMIWDS_KA_TLV_HDR
{
    USHORT Type;
    USHORT Length;
}__attribute__ ((packed)) QMIWDS_KA_TLV_HDR, *PQMIWDS_KA_TLV_HDR;

typedef struct _QMIWDS_KEEP_ALIVE_TYPE_VALUE_REQ
{
    UCHAR  TLVType;
    USHORT TLVLength;
    UINT   keepAliveType;
}__attribute__ ((packed)) QMIWDS_KEEP_ALIVE_TYPE_VALUE_REQ, *PQMIWDS_KEEP_ALIVE_TYPE_VALUE_REQ;

typedef struct _QMIWDS_KEEP_ALIVE_TIMER_VALUE_REQ
{
    UCHAR  TLVType;
    USHORT TLVLength;
    UINT   timerValue;
}__attribute__ ((packed)) QMIWDS_KEEP_ALIVE_TIMER_VALUE_REQ, *PQMIWDS_KEEP_ALIVE_TIMER_VALUE_REQ;

typedef struct _QMIWDS_KEEP_ALIVE_PORT_VALUE_REQ
{
    UCHAR  TLVType;
    USHORT TLVLength;
    USHORT port;
}__attribute__ ((packed)) QMIWDS_KEEP_ALIVE_PORT_VALUE_REQ, *PQMIWDS_KEEP_ALIVE_PORT_VALUE_REQ;

typedef struct _QMIWDS_START_KEEP_ALIVE_RESPONSE_TLV {
    UCHAR  TLVType;
    USHORT TLVLength;
    UINT   keepAliveHandle;
} __attribute__ ((packed)) QMIWDS_START_KEEP_ALIVE_RESPONSE_TLV, *PQMIWDS_START_KEEP_ALIVE_RESPONSE_TLV;
#endif
/*zhangqingyun add for support cts 2023-12-6 start*/
typedef struct _QMIDMS_SET_TRIGGER_MODEM_ACTIVITY_INFO_CALCULATION {
    USHORT Type;             // QMUX type 0x005E
    USHORT Length;
    UCHAR  TLVType;          // 0x10
    USHORT TLVLength;        // 1
    UCHAR  enable_statistics;     //  0x00 disable modem activity statics ,0x01 enable )
} __attribute__ ((packed)) QMIDMS_SET_TRIGGER_MODEM_ACTIVITY_INFO_CALCULATION, *PQMIDMS_SET_TRIGGER_MODEM_ACTIVITY_INFO_CALCULATION;
...
typedef struct _QMIWDS_PROFILE_RESP_IDENTIFIER {
    UCHAR  TLVType;
    USHORT TLVLength;
    UCHAR  ProfileType;
    UCHAR  ProfileIndex;

} __attribute__ ((packed)) QMIWDS_PROFILE_RESP_IDENTIFIER, *PQMIWDS_PROFILE_RESP_IDENTIFIER;
...
typedef struct _QMIWDS_CREATE_PROFILE_SETTINGS_RESP_MSG {
    ...
    USHORT QMUXResult;
    USHORT QMUXError;
} __attribute__ ((packed)) QMIWDS_CREATE_PROFILE_SETTINGS_RESP_MSG, *PQMIWDS_CREATE_PROFILE_SETTINGS_RESP_MSG;
/*zhaopengfei@meigsmart.com-2021-0729 create new apn when modify failed End */
...
/*zhangqingyun add for support modem activity info 2023-12-5*/
#define QMIDMS_TRIGGER_MODEM_ACTIVITY_INFO_CALCULATION_REQ     0x005E
#define QMIDMS_GET_MODEM_ACTIVITY_INFO        0x005F 
...
typedef struct _NR5G_SERVICE_STATUS {
    UCHAR  TLVType;
    USHORT TLVLength;
    UCHAR  SrvStatus;
    UCHAR  TrueSrvsStatus;
    UCHAR  IsPrefDataPath;
} __attribute__ ((packed)) NR5G_SERVICE_STATUS, *PNR5G_SERVICE_STATUS;
...
#define QMIUIM_UIM_AUTHENTICATION_REQ         0x0034
/*zhangqingyun add for support esim 2023-7-20 start*/
#define QMIUIM_UIM_LOGICAL_CHANNEL       0x003F
#define QMIUIM_UIM_SEND_APDU_LOGICAL_CHANNEL    0x003B
#define QMIUIM_GET_SIM_ATR               0x0041
#define QMIUIM_UIM_OPEN_LOGICAL_CHANNEL       0x0042
#define QMIUIM_GET_SIM_EID               0x0065
#define QMI_WDS_MODEM_ASSISTED_KA_START_REQ     0x00D6
...
//zpf
        ...
        QMIBODYSAR_SET_SAR_VALUE_REQ              SetSarValue;
        /*zhangqingyun add for support body sar 2023-3-21 end*/
		/*zhangqingyun add for support esim 2023-7-21 start*/
		QMISIM_OPEN_CHANNEL_VALUE_REQ             SimOpenChannel;
		QMISIM_CLOSE_CHANNEL_VALUE_REQ            SimCloseChannel;
		QMISIM_TRANSMIT_APDU_LOGIC_CHANNEL_VALUE_REQ SimTransmitApduLogicChannel;
		QMIUIM_GET_ATR_REQ_MSG                    GetSimAtr;
		QMIUIM_GET_EID_REQ_MSG                    GetSimEid;
		/*zhangqingyun add for support esim 2023-7-21 end*/
#ifdef MEIG_NEW_FEATURE
        QMIUIM_AUTH_TLV_HDR                       UimAuthentication;
#endif
		/*zhangqingyun add for support cts 2023-12-6 start*/
		QMIDMS_SET_TRIGGER_MODEM_ACTIVITY_INFO_CALCULATION   TriggerModemActivityCalculation;
		/*zhangqingyun add for support cts 2023-12-6 end*/
#if 0
        ...
        QMIWDS_KA_TLV_HDR                         WdsStartKeepAlive;
    };
