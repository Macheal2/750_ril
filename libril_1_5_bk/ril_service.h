...
int setLinkCapacityReportingCriteriaResponse(int slotId,
                              int responseType, int serial, RIL_Errno e,
                              void *response, size_t responselen);
int getUiccApplicationsEnablementResponse(int slotId,
                              int responseType, int serial, RIL_Errno e,
                              void *response, size_t responselen);
/*zhangqingyun add support 2023-11-9 end*/
							  
/*zhangqingyun add cts support 2023-12-7 start*/
int setSystemSelectionChannelsResponse(int slotId,
                              int responseType, int serial, RIL_Errno e,
                              void *response, size_t responselen);
/*zhangqingyun add cts support 2023-12-7 end*/
//zqy add 1.3 hal
int enableModemResponse(int slotId,
                          int responseType, int serial, RIL_Errno e,
                          void *response, size_t responselen);

int  getModemStatusResponse(int slotId,
                          int responseType, int serial, RIL_Errno e,
                          void *response, size_t responselen);
void setNitzTimeReceived(int slotId, int64_t timeReceived);
/*zhangqingyun add hal 1.4 cts test*/
int setEmergencyDialResponse(int slotId,
                              int responseType, int serial, RIL_Errno e,
                              void *response, size_t responselen);
