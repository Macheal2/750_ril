...
/*zhangqingyun add for support body sar 2023-3-30 start*/

#define RIL_REQUEST_GET_SAR_RF_STATE 152

#define RIL_REQUEST_SET_SAR_RF_STATE 153
/*zhangqingyun add for support boyd sar 2023-3-30 end*/
