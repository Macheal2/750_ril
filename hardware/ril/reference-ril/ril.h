...
typedef enum {
    ...
    PREF_NET_TYPE_5G                                 = 25  /*zhangqingyun add 2023-11-3*/
...
typedef struct {
    ...
    union {
        ...
        RIL_NgranBands ngran_bands[MAX_BANDS]; //zhangqingyun add for cts
    } bands;
...
/*zhangqingyun add to rilrequest id according to rilConsttants.java 2023-12-5 start*/
...
/*zhangqingyun add to rilrequest id according to rilConstatnts.java 2023-12-5 end*/
