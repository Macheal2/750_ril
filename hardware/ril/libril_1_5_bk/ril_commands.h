...
*/
    ...
    //zhangqingyun add not match index for cts 2023-12-8
    {RIL_REQUEST_ENABLE_MODEM, radio::enableModemResponse}, 
    {RIL_REQUEST_GET_MODEM_STATUS, radio::getModemStatusResponse},
    {0, NULL},  
    {0, NULL},  
    {0, NULL},  
    {0, NULL},
    ...
    {0, NULL},
    {RIL_REQUEST_EMERGENCY_DIAL, radio::setEmergencyDialResponse},
    {0, NULL},
    {0, NULL},
    {0, NULL},
    {RIL_REQUEST_GET_UICC_APPLICATIONS_ENABLEMENT, radio::getUiccApplicationsEnablementResponse},
