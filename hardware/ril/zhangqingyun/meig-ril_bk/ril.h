...
typedef enum {
    ...
    /*[zhaopf@meigsmart.com]add for 5g support {*/
    RADIO_TECH_NR5G = 20,
    /*[zhaopf@meigsmart.com]add for 5g support }*/
...
/*zhangqingyun add for support esim 2023-9-6 start*/
...
/*zhangqingyun add for support esim 2023-9-6 end*/
...
typedef enum {
    ...
    CDMA  = 0x05,   // Code Division Multiple Access Radio Access Network
    IWLAN = 0x06    // IWLAN Radio Access Network
} RIL_RadioAccessNetworks;
...
typedef struct {
    ...
    union {
        ...
        RIL_NgranBands ngran_bands[MAX_BANDS]; //zhangqingyun add cts
    } bands;
...
/*zhangqingyun add for cts test 2023-12-6 start*/
typedef struct {
...
/*zhangqingyun add for cts test 2023-12-6 end*/
typedef struct {
...
/*[zhaopf@megismart-2020-06-23]add for meig key supprt { */
...
#endif
/*[zhaopf@megismart-2020-06-23]add for meig key supprt } */
/*zhangqingyun add for support body sar get start 2023-3-21 start*/
#define RIL_REQUEST_GET_SAR_RF_STATE 151
/**
 * RIL_REQUEST_GET_SAR_RF_STATE
 *
 * read sar value from modem
 *
 * Requests that a keepalive session with the given handle be stopped.
 * there is no parameter for this request.
 *
 * "data" is an string handle
 * "response" is sarvalue
 *
 * Valid errors:
 *  SUCCESS
 *  INVALID_ARGUMENTS
 *
 */
/*zhangqingyun add for support body sar get 2023-3-21 end*/
/*zhangqingyun add for support body sar set start 2023-3-21 start*/
#define RIL_REQUEST_SET_SAR_RF_STATE 152
/**
 * RIL_REQUEST_SET_SAR_RF_STATE
 *
 * set sar value to modem
 *
 * Requests that a keepalive session with the given handle be stopped.
 * there is no parameter for this request.
 *
 ...
 *
 */
/*zhangqingyun add for support body sar set 2023-3-21 end*/
 ...
 * RADIO_NOT_AVAILABLE
 */
/*zhangqingyun add request id according to rilContstants.java 2023-12-5 start*/
...
/*zhangqingyun add request id according to rilConstants.java 2023-12-5 end*/
