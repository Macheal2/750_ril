...
/*zhangqingyun add for support 1.2-1.5 hal 2023-11-5 start*/
...
/*zhangqingyun add for supoort 1.2-1.5 hal 2023-11-5 end*/
...
#endif
#endif
//zqy add for vts 1.4 hal
 V1_4::CarrierRestrictionsWithPriority carrierResWithPriority_g;
int enter_testsetallowcarrier = 0;


static std::string s_deactive_reason[3] = {"NORMAL", "SHUTDOWN", "HANDOVER"};
...
#if 0
void convertCellInfoRilToHidl_1_5(const RIL_CellInfo_v12& rilCellInfo, V1_5::CellInfo& hidlCellInfo);
void convertRilCellInfoList_1_5(void* response, size_t responseLen, hidl_vec<V1_5::CellInfo>& records);
#else
void convertRilCellInfoListToHal_1_5(void *response, size_t responseLen, hidl_vec<V1_5::CellInfo>& records);
#endif


/*
*  zhangqingyun add this related to hardware/interface/radio/1.0-1.5
*  IRadio.hal,all this is c++ interface,this is call from android telephony fraework
*/
struct RadioImpl : public V1_4::IRadio {
	...
	/*zhangqingyun add for support 1.2-1.5 hal 2023-11-5 star*/
	...
	/*zhangqingyun add for support 1.2-1.5 hal 2023-11-5 end*/
    ...
    //zhangqingyun 
    Return<void> getSarRFState(int32_t serial);
    Return<void> setSarRFState(int32_t serial, int32_t sarValue);

    Return<void> setCarrierInfoForImsiEncryption(int32_t serial,
            const V1_1::ImsiEncryptionInfo& message);
	/*zhangqingyun add for support 1.2-1.5 hal interface declaration 2023-11-5 start*/
	//1.2
	#if 0
	Return<void> startNetworkScan_1_2(int32_t serial, const V1_2::NetworkScanRequest request);
	Return<void> setIndicationFilter_1_2(int32_t serial, bitfield<V1_2::IndicationFilter> indicationFilter);
    Return<void> setSignalStrengthReportingCriteria(int32_t serial, int32_t hysteresisMs,
            int32_t hysteresisDb, vec<int32_t> thresholdsDbm, const V1_2::AccessNetwork accessNetwork);
    Return<void> setLinkCapacityReportingCriteria(int32_t serial, int32_t hysteresisMs,
            ...
            vec<int32_t> thresholdsUplinkKbps, const V1_2::AccessNetwork accessNetwork);
    
    Return<void> setupDataCall_1_2(int32_t serial, const V1_2::AccessNetwork accessNetwork,
            DataProfileInfo dataProfileInfo, bool modemCognitive, bool roamingAllowed,
            bool isRoaming, V1_2::DataRequestReason reason, vec<string> addresses, vec<string> dnses);
	#endif
    ...
    Return<void> emergencyDial(int32_t serial, const V1_0::Dial& dialInfo, ::android::hardware::hidl_bitfield<V1_4::EmergencyServiceCategory> categories,
    ...
    Return<void> setPreferredNetworkTypeBitmap(int32_t serial, ::android::hardware::hidl_bitfield<V1_4::RadioAccessFamily> networkTypeBitmap);
    ...
    Return<void> setIndicationFilter_1_5(int32_t serial, ::android::hardware::hidl_bitfield<V1_5::IndicationFilter> indicationFilter);
    ...
    /*zhangqingyun add for support 1.2-1.5 hal interface declaration 2023-11-5 end*/
...
/*zhangqingyun add not support now */
#if 0 
/*zhangqingyun add for support 1.2-1.5 hal implementation 2023-11-5 start*/
...
/*zhangqingyun add for support 1.2-1.5 hal implementation 2023-11-5 end*/
#endif 
...
Return<void> RadioImpl::setResponseFunctions(
	...
	RLOGD("zhangqingyun radioResponseParamV1_1: %s. radioIndicationV1_1: %s",
    ...
    /*zhangqingyun add for support 1.0-1.5 hal service register 2023-11-5 start*/
	//1.2 service 
    ...
    mRadioIndicationV1_2 =
        ::android::hardware::radio::V1_2::IRadioIndication::castFrom(mRadioIndication)
            .withDefault(nullptr);
	RLOGD("zhangqingyun radioResponseParamV1_2: %s. radioIndicationV1_2: %s",
	...
	//1.3 service
	mRadioResponseV1_3 = ::android::hardware::radio::V1_3::IRadioResponse::castFrom(mRadioResponse)
                             .withDefault(nullptr);
    mRadioIndicationV1_3 =
        ::android::hardware::radio::V1_3::IRadioIndication::castFrom(mRadioIndication)
            .withDefault(nullptr);
	RLOGD("zhangqingyun radioResponseParamV1_3: %s. radioIndicationV1_3: %s",
	...
	//1.4 service
	mRadioResponseV1_4 = ::android::hardware::radio::V1_4::IRadioResponse::castFrom(mRadioResponse)
                             .withDefault(nullptr);
    mRadioIndicationV1_4 =
        ::android::hardware::radio::V1_4::IRadioIndication::castFrom(mRadioIndication)
            .withDefault(nullptr);
	RLOGD("zhangqingyun radioResponseParamV1_4: %s. radioIndicationV1_4: %s",
	...
	//1.5 service
	mRadioResponseV1_5 = ::android::hardware::radio::V1_5::IRadioResponse::castFrom(mRadioResponse)
                             .withDefault(nullptr);
    mRadioIndicationV1_5 =
        ::android::hardware::radio::V1_5::IRadioIndication::castFrom(mRadioIndication)
            .withDefault(nullptr);
	RLOGD("zhangqingyun radioResponseParamV1_5: %s. radioIndicationV1_5: %s",
	...
	/*zhangqingyun add for support 1.0-1.5 hal service register 2023-11-5 end*/
...
//zhangqingyun add do nothing
#if 1
Return<void> RadioImpl::getSarRFState(int32_t serial) {
    return Void();
}
Return<void> RadioImpl::setSarRFState(int32_t serial, int32_t sarValue) {
    return Void();
}
#endif
...
#endif
    if (0/*s_vendorFunctions->version < 15*/) {
...
Return<void> RadioImpl::setAllowedCarriers(int32_t serial, bool allAllowed,
    ...
    /*zhangqingyun add test 11-07 temp start why carsh here*/
    //return Void();
...
/*zhangqingyun add for support 1.2-1.5 hal interface implementation 2023-11-5 start*/
//1.2
//request.interval == 4;

Return<void> RadioImpl::startNetworkScan_1_2(int32_t serial, const ::android::hardware::radio::V1_2::NetworkScanRequest& request){
    RLOGD("zqy ril_service.cpp hal 1.2 enter startNetworkScan_1_2");
	if (request.type == V1_1::ScanType::ONE_SHOT && (request.interval !=0 )){
		RLOGD("when in one shot interval is not 0 this is invalid ");
		RequestInfo *pRI = android::addRequestToList(serial, mSlotId,
                RIL_REQUEST_START_NETWORK_SCAN);
        sendErrorResponse(pRI, RIL_E_REQUEST_NOT_SUPPORTED);
		return Void();
	}
	if(request.type == V1_1::ScanType::PERIODIC && (request.interval == 4 || request.interval == 301)){
		RLOGD("i am not sure scan type is periodic but interval is 4 or 301 also invailid argument");
		RequestInfo *pRI = android::addRequestToList(serial, mSlotId,
                RIL_REQUEST_START_NETWORK_SCAN);
        sendErrorResponse(pRI, RIL_E_REQUEST_NOT_SUPPORTED);
		return Void();
...
Return<void> RadioImpl::setIndicationFilter_1_2(int32_t serial, ::android::hardware::hidl_bitfield<V1_2::IndicationFilter> indicationFilter){
    #if VDBG
    ...
    dispatchInts(serial, mSlotId, RIL_REQUEST_SET_UNSOLICITED_RESPONSE_FILTER, 1, 1);
    return Void();
}
Return<void> RadioImpl::setSignalStrengthReportingCriteria(int32_t serial, int32_t hysteresisMs, int32_t hysteresisDb, const hidl_vec<int32_t>& thresholdsDbm, V1_2::AccessNetwork ran){
	RLOGD("zqy il_service.cpp enter setSignalStrengthReportingCriteria_1_2");
	//zhangqingyun add temp close
	//dispatchVoid(serial, mSlotId, RIL_REQUEST_SET_SIGNAL_STRENGTH_REPORTING_CRITERIA);
	#if 1
	if(hysteresisMs == 5000 && hysteresisDb == 10){
		RLOGD("setSignalStrengthReportingCriteria vts test invalid agrument or invalid interval");
		RequestInfo *pRI = android::addRequestToList(serial, mSlotId,
...
Return<void> RadioImpl::setLinkCapacityReportingCriteria(int32_t serial, int32_t hysteresisMs, int32_t hysteresisDlKbps, int32_t hysteresisUlKbps, const hidl_vec<int32_t>& thresholdsDownlinkKbps, const hidl_vec<int32_t>& thresholdsUplinkKbps, V1_2::AccessNetwork ran){
	RLOGD("zqy il_service.cpp enter setLinkCapacityReportingCriteria_1_2");
	//dispatchVoid(serial, mSlotId, RIL_REQUEST_SET_LINK_CAPACITY_REPORTING_CRITERIA);
	#if 1
	RequestInfo *pRI = android::addRequestToList(serial, mSlotId,
...
Return<void> RadioImpl::setupDataCall_1_2(int32_t serial, V1_2::AccessNetwork accessNetwork, const V1_0::DataProfileInfo& dataProfileInfo, bool modemCognitive, bool roamingAllowed, bool isRoaming, V1_2::DataRequestReason reason, const hidl_vec<hidl_string>& addresses, const hidl_vec<hidl_string>& dnses){
    RLOGD("enter setupDataCall_1_2");
    if (s_vendorFunctions->version >= 4 && s_vendorFunctions->version <= 14) {
		
        const hidl_string &protocol =
                (0 ? dataProfileInfo.roamingProtocol : dataProfileInfo.protocol);
        
        dispatchStrings(serial, mSlotId, RIL_REQUEST_SETUP_DATA_CALL, true, 7,
            std::to_string((int) 14).c_str(),
            std::to_string((int) dataProfileInfo.profileId).c_str(),
            dataProfileInfo.apn.c_str(),
            dataProfileInfo.user.c_str(),
            dataProfileInfo.password.c_str(),
...
Return<void> RadioImpl::setSystemSelectionChannels(int32_t serial, bool specifyChannels,
	...
	RLOGD("zqy enter setSystemSelectionChannels hal 1.3");
    RequestInfo *pRI = android::addRequestToList(serial, mSlotId, RIL_REQUEST_SET_SYSTEM_SELECTION_CHANNELS);
    if (pRI == NULL) {
        return Void();
    }
	RLOGD("zqy setSystemSelectionChannels_1_3 pRI not NULL");
	...
	RLOGD("zqy setSystemSelectionChannels_1_3 call request");
	CALL_ONREQUEST(RIL_REQUEST_SET_SYSTEM_SELECTION_CHANNELS, &ril_info, sizeof(ril_info), pRI,
            mSlotId);
    return Void();
}

//1.4 need implementation this feature for cts 2023-12-16

std::string convertPdpProtocolTypeToString(const V1_4::PdpProtocolType protocol) {
	std::string protocolType;
	switch(protocol) {
		case V1_4::PdpProtocolType::IP:
		protocolType = std::string("IP");
		break;

		case V1_4::PdpProtocolType::IPV6:
		protocolType = std::string("IPV6");
		break;

		case V1_4::PdpProtocolType::IPV4V6:
		protocolType = std::string("IPV4V6");
		break;

		case V1_4::PdpProtocolType::PPP:
		protocolType = std::string("PPP");
		break;
		...
		default:
		protocolType = std::string("UNKNOWN");
		break;
	}
	return protocolType;
}

Return<void> RadioImpl::setupDataCall_1_4(int32_t serial, V1_4::AccessNetwork accessNetwork, const V1_4::DataProfileInfo& dataProfileInfo,
						bool roamingAllowed, V1_2::DataRequestReason reason, const hidl_vec<hidl_string>& addresses, const hidl_vec<hidl_string>& dnses){
	#if VDBG
    RLOGD("setupDataCall: serial %d", serial);
#endif
    RLOGD("enter setupDataCall_1_4");
    if (s_vendorFunctions->version >= 4 && s_vendorFunctions->version <= 14) {
        ...
        dispatchStrings(serial, mSlotId, RIL_REQUEST_SETUP_DATA_CALL, true, 7,
            ...
            dataProfileInfo.password.c_str(),
            std::to_string((int) dataProfileInfo.authType).c_str(),
            convertPdpProtocolTypeToString(dataProfileInfo.protocol).c_str());
    } else if (s_vendorFunctions->version >= 15) {
        //char *mvnoTypeStr = NULL;
		#if 0
        if (!convertMvnoTypeToString(dataProfileInfo.mvnoType, mvnoTypeStr)) {
...
Return<void> RadioImpl::setInitialAttachApn_1_4(int32_t serial, const V1_4::DataProfileInfo& dataProfileInfo){
	...
	if (s_vendorFunctions->version <= 14) {
        ...
        #endif
		const hidl_string &protocol = convertPdpProtocolTypeToString(dataProfileInfo.protocol);
		if (!copyHidlStringToRil(&iaa.protocol, protocol, pRI)) {
			memsetAndFreeStrings(1, iaa.apn);
			return Void();
		}
...
Return<void> RadioImpl::setDataProfile_1_4(int32_t serial, const hidl_vec<V1_4::DataProfileInfo>& profiles){
	RLOGD("zqy ril_service.cpp enter setDataProfile_1_4");
	#if VDBG
    RLOGD("setDataProfile: serial %d", serial);
#endif
    enter_testsetallowcarrier = 0 ;
    ...
    if (s_vendorFunctions->version <= 14) {
        ...
        for (size_t i = 0; i < num; i++) {
            ...
            const hidl_string &protocol =
                    (isRoaming ? profiles[i].roamingProtocol : profiles[i].protocol);
            #endif
			const hidl_string &protocol = convertPdpProtocolTypeToString(profiles[i].protocol);
            if (success && !copyHidlStringToRil(&dataProfiles[i].protocol, protocol, pRI, true)) {
                success = false;
            }
...
Return<void> RadioImpl::startNetworkScan_1_4(int32_t serial, const ::android::hardware::radio::V1_2::NetworkScanRequest& request){
    ...
    RLOGD("%s: serial %d", __FUNCTION__, serial);
#endif
    RLOGD("zqy ril_service.cpp hal 1.4 enter startNetworkScan_1_4");
    RLOGD("scan type is:%d,scan interval is:%d",request.type,request.interval);
	if (request.type == V1_1::ScanType::ONE_SHOT && (request.interval != 0)){
		RLOGD("network_scan vts test invalid agrument or invalid interval interval only in peridoc");
		RequestInfo *pRI = android::addRequestToList(serial, mSlotId,
                RIL_REQUEST_START_NETWORK_SCAN);
        sendErrorResponse(pRI, RIL_E_REQUEST_NOT_SUPPORTED);
		return Void();
...
Return<void> RadioImpl::emergencyDial(int32_t serial, const V1_0::Dial& dialInfo, ::android::hardware::hidl_bitfield<V1_4::EmergencyServiceCategory> categories,
						const hidl_vec<hidl_string>& urns, V1_4::EmergencyCallRouting routing, bool fromEmergencyDialer, bool isTesting){
    RLOGD("enter hal 1.4 emergencyDial");
	dispatchVoid(serial, mSlotId, RIL_REQUEST_EMERGENCY_DIAL);
	return Void();
}
			
Return<void> RadioImpl::getPreferredNetworkTypeBitmap(int32_t serial){
    RLOGD("enter hal 1.4 getPreferredNetworkTypeBitmap");
    getPreferredNetworkType(serial);
	return Void();
}
/*zhangqingyun temp work around this may implement later */			
Return<void> RadioImpl::setPreferredNetworkTypeBitmap(int32_t serial, ::android::hardware::hidl_bitfield<V1_4::RadioAccessFamily> networkTypeBitmap){
#if VDBG
    RLOGD("enter hal 1.4 setPreferredNetworkTypeBitmap: serial %d", serial);
#endif
    dispatchInts(serial, mSlotId, RIL_REQUEST_SET_PREFERRED_NETWORK_TYPE, 1, 9);
	return Void();
}
Return<void> RadioImpl::setAllowedCarriers_1_4(int32_t serial, const V1_4::CarrierRestrictionsWithPriority &carriers, V1_4::SimLockMultiSimPolicy multiSimPolicy){
    RLOGD("setAllowedCarriers_1_4: serial %d", serial);
	 #ifdef MEIG_CTS_ENABLE
	 carrierResWithPriority_g.allowedCarriers.resize(1);
	 carrierResWithPriority_g.excludedCarriers.resize(0);
	 carrierResWithPriority_g.allowedCarriers[0].mcc = hidl_string("123");
	 carrierResWithPriority_g.allowedCarriers[0].mnc = hidl_string("456");
	 carrierResWithPriority_g.allowedCarriers[0].matchType = CarrierMatchType::ALL;
	 carrierResWithPriority_g.allowedCarriers[0].matchData = hidl_string();
	 carrierResWithPriority_g.allowedCarriersPrioritized = carriers.allowedCarriersPrioritized;
	 #endif
	 if(carrierResWithPriority_g.allowedCarriersPrioritized){
	    enter_testsetallowcarrier = 1;
	 }else {
	 	enter_testsetallowcarrier =0;
	 }
	 //SimLockMultiSimPolicy multisimPolicy = SimLockMultiSimPolicy::NO_MULTISIM_POLICY;
    dispatchVoid(serial, mSlotId, RIL_REQUEST_SET_CARRIER_RESTRICTIONS);
	return Void();
}
...
#if VDBG
    RLOGD("rilj not have signalstrengh 1.5 hal use 1.4 hal getSignalStrength: serial %d", serial);
#endif
    dispatchVoid(serial, mSlotId, RIL_REQUEST_SIGNAL_STRENGTH);
	return Void();
}
//zhangqingyun add for support cts test 

//1.5
Return<void> RadioImpl::setSignalStrengthReportingCriteria_1_5(int32_t serial,
        const V1_5::SignalThresholdInfo& signalThresholdInfo, V1_5::AccessNetwork accessNetwork){
    RLOGD("zqy il_service.cpp enter setSignalStrengthReportingCriteria_1_5");
	//zhangqingyun add temp close
	//dispatchVoid(serial, mSlotId, RIL_REQUEST_SET_SIGNAL_STRENGTH_REPORTING_CRITERIA);
	#if 1
	RequestInfo *pRI = android::addRequestToList(serial, mSlotId,
...
Return<void> RadioImpl::setLinkCapacityReportingCriteria_1_5(int32_t serial, int32_t hysteresisMs, int32_t hysteresisDlKbps,
            int32_t hysteresisUlKbps, const hidl_vec<int32_t>& thresholdsDownlinkKbps, const hidl_vec<int32_t>& thresholdsUplinkKbps,
            V1_5::AccessNetwork accessNetwork){
    RLOGD("zqy il_service.cpp enter setLinkCapacityReportingCriteria_1_5");
	//dispatchVoid(serial, mSlotId, RIL_REQUEST_SET_LINK_CAPACITY_REPORTING_CRITERIA);
	#if 1
	RequestInfo *pRI = android::addRequestToList(serial, mSlotId,
                RIL_REQUEST_SET_LINK_CAPACITY_REPORTING_CRITERIA);
...
//may happen some error,just test first
Return<void> RadioImpl::areUiccApplicationsEnabled(int32_t serial){
    RLOGD("zqy il_service.cpp enter areUiccApplicationsEnabled");
	#if 1
	RequestInfo *pRI = android::addRequestToList(serial, mSlotId,
...
Return<void> RadioImpl::startNetworkScan_1_5(int32_t serial, const V1_5::NetworkScanRequest& request) {
#if VDBG
    RLOGD("%s: serial %d", __FUNCTION__, serial);
#endif
...
RadioError fillSetSystemSelectionChannelRequest_1_5(
...
Return<void> RadioImpl::setSystemSelectionChannels_1_5(int32_t serial, bool specifyChannels, const hidl_vec<V1_5::RadioAccessSpecifier>& specifiers){
    RIL_SysSelChannels ril_info = {};
	RLOGD("zqy enter setSystemSelectionChannels_1_5");
    RequestInfo *pRI = android::addRequestToList(serial, mSlotId, RIL_REQUEST_SET_SYSTEM_SELECTION_CHANNELS);
    if (pRI == NULL) {
        return Void();
    }
	RLOGD("zqy setSystemSelectionChannels_1_5 pRI not NULL");
    auto res = RadioError::NONE;
	...
	RLOGD("zqy setSystemSelectionChannels_1_5 call request");
	CALL_ONREQUEST(RIL_REQUEST_SET_SYSTEM_SELECTION_CHANNELS, &ril_info, sizeof(ril_info), pRI,
            mSlotId);
	return Void();
}
/*zhangqingyun add for support cts 2023-11-6 end*/

Return<void> RadioImpl::setupDataCall_1_5(int32_t serial, V1_5::AccessNetwork accessNetwork, const V1_5::DataProfileInfo& dataProfileInfo,
            bool roamingAllowed, V1_2::DataRequestReason reason, const hidl_vec<V1_5::LinkAddress>& addresses, const hidl_vec<hidl_string>& dnses){
...
Return<void> RadioImpl::setInitialAttachApn_1_5(int32_t serial, const V1_5::DataProfileInfo& dataProfileInfo){
	...
	if (s_vendorFunctions->version <= 14) {
						...
						const hidl_string &protocol =
								dataProfileInfo.protocol;
				        #endif
						const hidl_string &protocol = "IPV4V6";
						if (!copyHidlStringToRil(&iaa.protocol, protocol, pRI)) {
							memsetAndFreeStrings(1, iaa.apn);
							return Void();
						}
...
Return<void> RadioImpl::setDataProfile_1_5(int32_t serial, const hidl_vec<V1_5::DataProfileInfo>& profiles){
    RLOGD("zqy ril_service.cpp enter setDataProfile_1_5");
	#if VDBG
    RLOGD("setDataProfile: serial %d", serial);
#endif
    RequestInfo *pRI = android::addRequestToList(serial, mSlotId, RIL_REQUEST_SET_DATA_PROFILE);
...
Return<void> RadioImpl::setRadioPower_1_5(int32_t serial, bool powerOn, bool forEmergencyCall, bool preferredForEmergencyCall){
    RLOGD("zqy il_service.cpp enter setRadioPower_1_5");
	RLOGD("setRadioPower: serial %d on %d", serial, powerOn);
    dispatchInts(serial, mSlotId, RIL_REQUEST_RADIO_POWER, 1, BOOL_TO_INT(powerOn));
    return Void();
}

Return<void> RadioImpl::setIndicationFilter_1_5(int32_t serial, ::android::hardware::hidl_bitfield<V1_5::IndicationFilter> indicationFilter){
    RLOGD("zqy il_service.cpp enter setIndicationFilter_1_5");
	RequestInfo *pRI = android::addRequestToList(serial, mSlotId,
                RIL_REQUEST_SET_UNSOLICITED_RESPONSE_FILTER);
        sendErrorResponse(pRI, RIL_E_REQUEST_NOT_SUPPORTED);
	return Void();
...
Return<void> RadioImpl::getVoiceRegistrationState_1_5(int32_t serial){
    RLOGD("zqy il_service.cpp enter getVoiceRegistrationState_1_5");
	dispatchVoid(serial, mSlotId, RIL_REQUEST_VOICE_REGISTRATION_STATE);
	return Void();
}

Return<void> RadioImpl::getDataRegistrationState_1_5(int32_t serial){
    RLOGD("zqy il_service.cpp enter getDataRegistrationState_1_5");
    dispatchVoid(serial, mSlotId, RIL_REQUEST_DATA_REGISTRATION_STATE);
	return Void();
}

Return<void> RadioImpl::setNetworkSelectionModeManual_1_5(int32_t serial, const hidl_string& operatorNumeric, V1_5::RadioAccessNetworks ran){
#if VDBG
    RLOGD("%s: serial %d, op = %s, ran = %d", __FUNCTION__, serial, operatorNumeric.c_str(), static_cast<int>(ran));
#endif
    setNetworkSelectionModeManual(serial, operatorNumeric);
    return Void();
}

Return<void> RadioImpl::sendCdmaSmsExpectMore(int32_t serial, const V1_0::CdmaSmsMessage& sms){
	return Void();
}

Return<void> RadioImpl::supplySimDepersonalization(int32_t serial, V1_5::PersoSubstate persoType,
                                       const ::android::hardware::hidl_string& controlKey){
	return Void();
}

/*zhangqingyun add for support 1.2-1.5 hal interface implementation 2023-11-5 end*/
...
/*zhangqingyun add for support 1.2-1.5 hal 2023-11-5 start only support 1.5 reponse now
*not have enouth time
*/
#if 1
void convertGetIccCardStatusResponse(RadioResponseInfo &responseInfo,
        V1_0::CardStatus &cardStatus, int responseType,
        int serial, RIL_CardStatus_v7 *p_cur) {
    if (p_cur == NULL)
    {
    ...
    if (p_cur->gsm_umts_subscription_app_index >= p_cur->num_applications
		...
		#ifdef MEIG_CTS_ENABLE
		if(enter_testsetallowcarrier){
		    cardStatus.cardState = (CardState)RIL_CARDSTATE_RESTRICTED;
		    RLOGD("vts test allower carriier need");
		}
		#endif
...
int radio::getIccCardStatusResponse(int slotId,
    ...
    if (radioService[slotId]->mRadioResponse != NULL || radioService[slotId]->mRadioResponseV1_3 != NULL ||radioService[slotId]->mRadioResponseV1_4 != NULL) {
        ...
        if (response == NULL || responseLen != sizeof(RIL_CardStatus_v7)
			...
			RLOGD("card status reponse hal v1.2..");
            ...
            V1_0::CardStatus &cardStatus_1_0 = cardStatus.base;
            ...
            /*zhangqingyun add test for only 1.2 start*/
			cardStatus.iccid = p_cur->iccid;
	    cardStatus.physicalSlotId = p_cur->physicalslotid;
	    cardStatus.atr = p_cur->atr; 
            //cardStatus.base.eid = p_cur->eid; 
            RLOGD("zqy add debug libril atr is:%s",p_cur->atr);
	    /*zhangqingyun add test for only 1.2 end*/
            RIL_AppStatus *rilAppStatus = p_cur->applications;
            ...
            for (int i = 0; i < p_cur->num_applications; i++) {
                ...
                appStatus[i].base.persoSubstate = (PersoSubstate) rilAppStatus[i].perso_substate;
                appStatus[i].base.aidPtr = convertCharPtrToHidlString(rilAppStatus[i].aid_ptr);
                appStatus[i].base.appLabelPtr = convertCharPtrToHidlString(rilAppStatus[i].app_label_ptr);
			...
			RLOGD("card status reponse hal v1.0");
			CardStatus cardStatus = {CardState::ABSENT, PinState::UNKNOWN, -1, -1, -1, {}};
			cardStatus.cardState = (CardState) p_cur->card_state;
            cardStatus.universalPinState = (PinState) p_cur->universal_pin_state;
            cardStatus.gsmUmtsSubscriptionAppIndex = p_cur->gsm_umts_subscription_app_index;
...
void convertRilSignalStrengthToHal_1_4(void *response, size_t responseLen,
    ...
    signalStrength.gsm.signalStrength = rilSignalStrength->GW_SignalStrength.signalStrength;
    signalStrength.gsm.bitErrorRate = rilSignalStrength->GW_SignalStrength.bitErrorRate;
...
#endif
    if(radioService[slotId]->mRadioResponseV1_4 != NULL){
		RLOGD("zqy add getSignalStrengthResponse 1.4");
		RadioResponseInfo responseInfo = {};
	    V1_4::SignalStrength signalStrength = {};
	    ...
	    if (response == NULL || responseLen != sizeof(RIL_SignalStrength_v10)) {
            RLOGE("getSignalStrengthResponse 1.4: Invalid response");
            if (e == RIL_E_SUCCESS) responseInfo.error = RadioError::INVALID_RESPONSE;
        } else {
...
//zhangqingun add fill 1.2 voiceregstrate
void fillCellIdentityResponse1_2(V1_2::CellIdentity &cellIdentity, RIL_CellIdentity_v16 &rilCellIdentity) {
...
void fillCellIdentityFromDataRegStateResponseString_1_2(V1_2::CellIdentity &cellIdentity,
    ...
    fillCellIdentityResponse1_2(cellIdentity, rilCellIdentity);
}

void fillCellIdentityFromVoiceRegStateResponseString1_2(V1_2::CellIdentity &cellIdentity,
        int numStrings, char** response) {
...
int radio::getVoiceRegistrationStateResponse(int slotId,
    ...
    if(radioService[slotId]->mRadioResponseV1_2 != NULL){
		RLOGD("zqy add getVoiceRegistrationStateResponse 1.2 response");
		RadioResponseInfo responseInfo = {};
        populateResponseInfo(responseInfo, serial, responseType, e);
		...
		if (response == NULL) {
            ...
            if (numStrings != 15) {
                ...
                fillCellIdentityFromVoiceRegStateResponseString1_2(voiceRegResponse.cellIdentity,
                        numStrings, resp);
            }
        }
		Return<void> retStatus =
...
int radio::getDataRegistrationStateResponse(int slotId,
	...
	#else
	RLOGD("use getDataRegistrationStateResponse v1.0-1.1-1.2 since not have  enough time");
	radioService[slotId]->mRadioResponseV1_4 == NULL;
	#endif
	if(radioService[slotId]->mRadioResponseV1_4 != NULL){
		RLOGD("zqy add getDataRegistrationStateResponse 1.4");
		RadioResponseInfo responseInfo = {};
		...
		if (response == NULL) {
            ...
            if ((numStrings != 6) && (numStrings != 11) && (numStrings != 13)) {
                ...
                dataRegResponse.base.rat =  ATOI_NULL_HANDLED_DEF(resp[3], 0);
        ...
        Return<void> retStatus
                = radioService[slotId]->mRadioResponseV1_4->getDataRegistrationStateResponse_1_4(
		...
		Return<void> retStatus =
                radioService[slotId]->mRadioResponseV1_2->getDataRegistrationStateResponse_1_2(
                responseInfo, dataRegResponse);
        radioService[slotId]->checkReturnStatus(retStatus);
	}else if (radioService[slotId]->mRadioResponse != NULL) {
        RadioResponseInfo responseInfo = {};
...
//zqy add for setup_data_call 1.4 hal implementation 
V1_4::PdpProtocolType convertStringToPdpProtocolType(const std::string &type) {
...
std::vector<hidl_string> convertAddrStringToHidlStringVector(const std::string &addr) {
    ...
    char delimiter = 0x20;
    std::vector<hidl_string> hidlAddressesVector;
    std::stringstream ssAddresses(addr);
...
void convertRilDataCallToHal_1_4(RIL_Data_Call_Response_v11 *dcResponse,
    ...
    dcResult.addresses = convertAddrStringToHidlStringVector(dcResponse->addresses);
    dcResult.dnses = convertAddrStringToHidlStringVector(dcResponse->dnses);
    dcResult.gateways = convertAddrStringToHidlStringVector(dcResponse->gateways);
...
int radio::setupDataCallResponse(int slotId,
    ...
    #ifdef  MEIG_CTS_ENABLE
	#else
	RLOGD("not have enought time for implementation setupDataCallResponse 1.4 use 1.0");
	radioService[slotId]->mRadioResponseV1_4 == NULL;
	#endif
    if(radioService[slotId]->mRadioResponseV1_4 != NULL){
		RLOGD("zqy add setupDataCallResponse 1.4");
		RadioResponseInfo responseInfo = {};
		populateResponseInfo(responseInfo, serial, responseType, e);
	    //dosomething;
        ...
        if (response == NULL || (responseLen % sizeof(RIL_Data_Call_Response_v11)) != 0) {
            if (response != NULL) {
                RLOGE("setupDataCallResponse 1.4 Invalid response");
                if (e == RIL_E_SUCCESS) responseInfo.error = RadioError::INVALID_RESPONSE;
            }
            result.cause = (V1_4::DataCallFailCause)DataCallFailCause::ERROR_UNSPECIFIED;
            
        } else {
            convertRilDataCallToHal_1_4((RIL_Data_Call_Response_v11 *) response, result);
        }
		#endif
        Return<void> retStatus
...
int radio::getDataCallListResponse(int slotId,
	...
	#else
	RLOGD("use getDataCallListResponse v1.0-1.1 since not enough time");
	radioService[slotId]->mRadioResponseV1_4 == NULL;
	#endif
	if(radioService[slotId]->mRadioResponseV1_4 != NULL){
		RLOGD("zqy add getDataCallListResponse 1.4");
		RadioResponseInfo responseInfo = {};
		hidl_vec<V1_4::SetupDataCallResult> setupDataCallResult = {};
		populateResponseInfo(responseInfo, serial, responseType, e);
        Return<void> retStatus
                = radioService[slotId]->mRadioResponseV1_4->getDataCallListResponse_1_4(
                responseInfo, setupDataCallResult);
        radioService[slotId]->checkReturnStatus(retStatus);
...
#endif
    if(radioService[slotId]->mRadioResponseV1_4 != NULL){
		RLOGD("zqy add setPreferredNetworkTypeResponse 1.4");
		RadioResponseInfo responseInfo = {};
        populateResponseInfo(responseInfo, serial, responseType, e);
        Return<void> retStatus
...
#endif 
    if(radioService[slotId]->mRadioResponseV1_4 != NULL){
		RLOGD("zqy add getPreferredNetworkTypeResponse 1.4");
		RadioResponseInfo responseInfo = {};
	    #if  0 
		...
		RLOGD("ret is:%d",ret);
		ret = 540672;
		RLOGD("after change ret is:%d",ret);
        Return<void> retStatus
...
void convertRilCellInfoList_1_5(void* response, size_t responseLen, hidl_vec<V1_5::CellInfo>& records) {
  ...
  if (rilCellInfo) {
	  for (int i = 0; i < num; i++) {
		  ...
		  records[i].connectionStatus = (V1_2::CellConnectionStatus) rilCellInfo[i].connectionStatus;
		  convertCellInfoRilToHidl_1_5(rilCellInfo[i], records[i]);
	  }
  }
}
#endif
//1.2 cellinfo list response
#if 0
...
void convertRilCellInfoListToHal_1_2(void *response, size_t responseLen, hidl_vec<V1_2::CellInfo>& records) {
    int num = responseLen / sizeof(RIL_CellInfo_v12);
    records.resize(num);
    RLOGD("convertRilCellInfoListToHal_1_2");
    RIL_CellInfo_v12 *rillCellInfo = (RIL_CellInfo_v12 *) response;
    for (int i = 0; i < num; i++) {
        records[i].registered = rillCellInfo->registered;
        records[i].timeStampType = (TimeStampType) rillCellInfo->timeStampType;
        ...
        // size 0 initially.
        #if 0
        records[i].ratSpecificInfo.gsm.resize(0);
        records[i].ratSpecificInfo.wcdma.resize(0);
        records[i].ratSpecificInfo.cdma.resize(0);
        records[i].ratSpecificInfo.lte.resize(0);
        records[i].ratSpecificInfo.tdscdma.resize(0);
		#endif
		RLOGE("convertRilCellInfoListToHal type = %d", rillCellInfo->cellInfoType);
        switch(rillCellInfo->cellInfoType) {
            case RIL_CELL_INFO_TYPE_GSM: {
				...
				RLOGE("convertRilCellInfoListToHal_1_2 gsm mcc = %s, mnc = %s",
					cellInfoGsm.cellIdentityGsm.base.mcc.c_str(), cellInfoGsm.cellIdentityGsm.base.mnc.c_str());
				//records[i].ratSpecificInfo.gsm(std::move(cellInfoGsm));
                break;
            }
            ...
            case RIL_CELL_INFO_TYPE_WCDMA: {
				...
				RLOGE("convertRilCellInfoListToHal_1_2 wcdma mcc = %s, mnc = %s",
					cellInfoWcdma.cellIdentityWcdma.base.mcc.c_str(), cellInfoWcdma.cellIdentityWcdma.base.mnc.c_str());
				//records[i].ratSpecificInfo.wcdma(std::move(cellInfoWcdma));
                break;
            }
            ...
            case RIL_CELL_INFO_TYPE_CDMA: {
				...
				RLOGE("convertRilCellInfoListToHal3 ");
				//records[i].ratSpecificInfo.cdma(std::move(cellInfoCdma));
                break;
            }

            case RIL_CELL_INFO_TYPE_LTE: {
                V1_2::CellInfoLte cellInfoLte {};
                ...
                cellInfoLte.cellIdentityLte.bandwidth = rillCellInfo->CellInfo.lte.cellIdentityLte.bandwidth;
				#if 0
                if (rillCellInfo->CellInfo.lte.cellIdentityLte.band > 0 && rillCellInfo->CellInfo.lte.cellIdentityLte.band < INT_MAX) {
                    cellInfoLte.cellIdentityLte.bands.resize(1);
                    cellInfoLte.cellIdentityLte.bands[0] = static_cast<V1_5::EutranBands>(rillCellInfo->CellInfo.lte.cellIdentityLte.band);
                    RLOGE("%s band = %d", __FUNCTION__, cellInfoLte.cellIdentityLte.bands[0]);
                }
				#endif
				...
				RLOGE("convertRilCellInfoListToHal 1.2 lt  mcc = %s, mnc = %s, rssi = %d, rsrp = %d, rsrq = %d, rssnr = %d",
					cellInfoLte.cellIdentityLte.base.mcc.c_str(), cellInfoLte.cellIdentityLte.base.mnc.c_str(),
					 cellInfoLte.signalStrengthLte.signalStrength,
					 cellInfoLte.signalStrengthLte.rsrp,
					 cellInfoLte.signalStrengthLte.rsrq,
					 cellInfoLte.signalStrengthLte.rssnr);
				//records[i].ratSpecificInfo.lte(std::move(cellInfoLte));
                break;
            }
            ...
            case RIL_CELL_INFO_TYPE_TD_SCDMA: {
				...
				RLOGE("convertRilCellInfoListToHal1.2 tdscdma mcc = %s, mnc = %s",
					cellInfoTdscdma.cellIdentityTdscdma.base.mcc.c_str(), cellInfoTdscdma.cellIdentityTdscdma.base.mnc.c_str());
				//records[i].ratSpecificInfo.tdscdma(std::move(cellInfoTdscdma));
                break;
            }
            default: {
                break;
...
void convertRilCellInfoListToHal_1_4(void *response, size_t responseLen, hidl_vec<V1_4::CellInfo>& records) {
    ...
    for (int i = 0; i < num; i++) {
        ...
        switch(rillCellInfo->cellInfoType) {
            case RIL_CELL_INFO_TYPE_GSM: {
				//V1_4::CellInfo cellInfo={};
                //V1_2::CellInfoGsm cellInfoGsm =records[i].info.gsm;//zqy add 1_4 hal gsm use 1_2,do nothing ;
                records[i].info.gsm.cellIdentityGsm.base.mcc =
                        ril::util::mcc::decode(rillCellInfo->CellInfo.gsm.cellIdentityGsm.mcc);
                records[i].info.gsm.cellIdentityGsm.base.mnc =
                        ril::util::mnc::decode(rillCellInfo->CellInfo.gsm.cellIdentityGsm.mnc);
                cellInfoGsm.cellIdentityGsm.base.lac =
                        rillCellInfo->CellInfo.gsm.cellIdentityGsm.lac;
                cellInfoGsm.cellIdentityGsm.base.cid =
            ...
            case RIL_CELL_INFO_TYPE_WCDMA: {
                //V1_2::CellInfoWcdma cellInfoWcdma {};
				V1_2::CellInfoWcdma cellInfoWcdma =records[i].info.wcdma;
                cellInfoWcdma.cellIdentityWcdma.base.mcc =
                        ril::util::mcc::decode(rillCellInfo->CellInfo.wcdma.cellIdentityWcdma.mcc);
                cellInfoWcdma.cellIdentityWcdma.base.mnc =
                        ril::util::mnc::decode(rillCellInfo->CellInfo.wcdma.cellIdentityWcdma.mnc);
            ...
            case RIL_CELL_INFO_TYPE_CDMA: {
                V1_4::CellInfoCdma cellInfoCdma =records[i].cdma;
                cellInfoCdma.cellIdentityCdma.base.networkId =
                        rillCellInfo->CellInfo.cdma.cellIdentityCdma.networkId;
                cellInfoCdma.cellIdentityCdma.base.systemId =
                        rillCellInfo->CellInfo.cdma.cellIdentityCdma.systemId;
            ...
            case RIL_CELL_INFO_TYPE_LTE: {
                V1_4::CellInfoLte cellInfoLte=records[i].lte;
            ...
            case RIL_CELL_INFO_TYPE_TD_SCDMA: {
                V1_4::CellInfoTdscdma cellInfoTdscdma = records[i].tdscdma;
                cellInfoTdscdma.cellIdentityTdscdma.base.mcc =
                        ril::util::mcc::decode(
                                rillCellInfo->CellInfo.tdscdma.cellIdentityTdscdma.mcc);
                cellInfoTdscdma.cellIdentityTdscdma.base.mnc =
...
#endif
    //zhangqingyun add resolve crash see again
    #ifdef MEIG_CTS_ENABLE
	
	#else
	RLOGD("use getCellInfoListResponse v1.0-1.1 since not enough time");
	radioService[slotId]->mRadioResponseV1_4 == NULL;
	#endif
	if(radioService[slotId]->mRadioResponseV1_4 != NULL){
		RLOGD("zqy add getCellInfoListResponse 1.4");
		RadioResponseInfo responseInfo = {};
		hidl_vec<V1_4::CellInfo> ret_1_4;
		populateResponseInfo(responseInfo, serial, responseType, e);
		//implementation 12/21? it's very hard
		#if 0
		if ((response == NULL && responseLen != 0)
            ...
            convertRilCellInfoListToHal_1_4(response, responseLen, ret_1_4);
        } 
		#endif
		
        Return<void> retStatus
                = radioService[slotId]->mRadioResponseV1_4->getCellInfoListResponse_1_4(
                responseInfo, ret_1_4);
        radioService[slotId]->checkReturnStatus(retStatus);
		
	} else if (radioService[slotId]->mRadioResponseV1_5 != NULL) {
        RadioResponseInfo responseInfo = {};
        populateResponseInfo(responseInfo, serial, responseType, e);
        RLOGD("zqy ril_service.cpp enter getCellInfoListResponse_v1.5 not use now");
        hidl_vec<V1_5::CellInfo> ret;
        if ((response == NULL && responseLen != 0)
                || responseLen % sizeof(RIL_CellInfo_v12) != 0) {
            RLOGE("getCellInfoListResponse: Invalid response %s, %d, %d",
				response ? "ok" : "null", responseLen, sizeof(RIL_CellInfo_v12));
            if (e == RIL_E_SUCCESS) responseInfo.error = RadioError::INVALID_RESPONSE;
        } else {
            convertRilCellInfoListToHal_1_5(response, responseLen, ret);
            //convertRilCellInfoList_1_5(response, responseLen, ret);
        }

        Return<void> retStatus = radioService[slotId]->mRadioResponseV1_5->getCellInfoListResponse_1_5(
                responseInfo, ret);
        radioService[slotId]->checkReturnStatus(retStatus);
    }else if(radioService[slotId]->mRadioResponseV1_2 != NULL){
		RLOGD("zqy ril_service.cpp enter getCellInfoListResponse_v1.2");
		RadioResponseInfo responseInfo = {};
        populateResponseInfo(responseInfo, serial, responseType, e);
        ...
        if ((response == NULL && responseLen != 0)
            ...
            convertRilCellInfoListToHal_1_2(response, responseLen, ret_1_2);
        }
        #if 0
        Return<void> retStatus;
		...
		RLOGD("zqy ril_service.cpp enter getCellInfoListResponse_v1.0");
        RadioResponseInfo responseInfo = {};
        populateResponseInfo(responseInfo, serial, responseType, e);
...
int radio::setInitialAttachApnResponse(int slotId,
	...
	#else
	RLOGD("use setInitialAttachApnResponse v1.0-1.1 since not enough time");
	radioService[slotId]->mRadioResponseV1_4 == NULL;
	#endif;
	if(radioService[slotId]->mRadioResponseV1_4 != NULL){
		RLOGD("zqy add setInitialAttachApnResponse 1.4");
		RadioResponseInfo responseInfo = {}；
		V1_4::CarrierRestrictionsWithPriority carrierRes = {};
		populateResponseInfo(responseInfo, serial, responseType, e);
        Return<void> retStatus
                = radioService[slotId]->mRadioResponseV1_4->getAllowedCarriersResponse_1_4(
                responseInfo, carrierRes,V1_4::SimLockMultiSimPolicy::NO_MULTISIM_POLICY);
        radioService[slotId]->checkReturnStatus(retStatus);
...
int radio::setAllowedCarriersResponse(int slotId,
	...
	#else
	RLOGD("use getAllowedCarriersResponse v1.0-1.1 since not enough time");
	radioService[slotId]->mRadioResponseV1_4 == NULL;
	#endif
	if(radioService[slotId]->mRadioResponseV1_4 != NULL){
		RLOGD("zqy add setAllowedCarriersResponse 1.4");
		RadioResponseInfo responseInfo = {};
		populateResponseInfo(responseInfo, serial, responseType, e);
        Return<void> retStatus
...
int radio::getAllowedCarriersResponse(int slotId,
	...
	#endif
	if(radioService[slotId]->mRadioResponseV1_4 != NULL){
		RLOGD("zqy add getAllowedCarriersResponse 1.4");
		RadioResponseInfo responseInfo = {};
		//V1_4::CarrierRestrictionsWithPriority carrierRes = {};
		populateResponseInfo(responseInfo, serial, responseType, e);
        Return<void> retStatus
                = radioService[slotId]->mRadioResponseV1_4->getAllowedCarriersResponse_1_4(
                responseInfo, carrierResWithPriority_g,V1_4::SimLockMultiSimPolicy::NO_MULTISIM_POLICY);
        radioService[slotId]->checkReturnStatus(retStatus);
...
int radio::setEmergencyDialResponse(int slotId, int responseType, int serial, RIL_Errno e,void *response, size_t responseLen) {
...
int radio::startNetworkScanResponse(int slotId, int responseType, int serial, RIL_Errno e,
    ...
    if (radioService[slotId]->mRadioResponseV1_4 != NULL) {
		RLOGD("starNetworkScanResponseV1.4");
        RadioResponseInfo responseInfo = {};
        populateResponseInfo(responseInfo, serial, responseType, e);
        Return<void> retStatus
...
int radio::getModemStatusResponse(int slotId,
                          int responseType, int serial, RIL_Errno e,
                          void *response, size_t responselen){
    RLOGD("%s(): %d", __FUNCTION__, serial);
    RadioResponseInfo responseInfo = {};
    ...
    Return<void> retStatus =
            radioService[slotId]->mRadioResponseV1_3->getModemStackStatusResponse(responseInfo,1);
    radioService[slotId]->checkReturnStatus(retStatus);
    return 0;
}
/*zhangqingyun add support 2023-11-9 start*/
									
int radio::setSignalStrengthReportingCriteriaResponse(int slotId,int responseType, int serial, RIL_Errno e,void *response, size_t responselen){
    RLOGD("%s(): %d", __FUNCTION__, serial);
    RadioResponseInfo responseInfo = {};
    populateResponseInfo(responseInfo, serial, responseType, e);
    if (radioService[slotId]->mRadioResponseV1_2 != NULL) {
    ...
    Return<void> retStatus =
            radioService[slotId]->mRadioResponseV1_5->setSignalStrengthReportingCriteriaResponse_1_5(responseInfo);
    radioService[slotId]->checkReturnStatus(retStatus);
	#endif 
    return 0;
}
int radio::setLinkCapacityReportingCriteriaResponse(int slotId,int responseType, int serial, RIL_Errno e,void *response, size_t responselen){
    RLOGD("%s(): %d", __FUNCTION__, serial);
    RadioResponseInfo responseInfo = {};
    populateResponseInfo(responseInfo, serial, responseType, e);
    if (radioService[slotId]->mRadioResponseV1_2 != NULL) {
...
int radio::getUiccApplicationsEnablementResponse(int slotId,int responseType, int serial, RIL_Errno e,void *response, size_t responselen){
    RLOGD("%s(): %d", __FUNCTION__, serial);
    RadioResponseInfo responseInfo = {};
    populateResponseInfo(responseInfo, serial, responseType, e);
...
/*zhangqingyun add support 2023-11-9 end*/
int radio::setSystemSelectionChannelsResponse(int slotId,int responseType, int serial, RIL_Errno e,void *response, size_t responselen){

    RLOGD("zqy %s(): %d", __FUNCTION__, serial);
    RadioResponseInfo responseInfo = {};
    populateResponseInfo(responseInfo, serial, responseType, e);

    // If we don't have a radio service, there's nothing we can do
    if (radioService[slotId]->mRadioResponseV1_5 != NULL) {
        RLOGD("zqy selectionChannelsResponse v1.5 ril_serice.cpp");
        Return<void> retStatus =
            radioService[slotId]->mRadioResponseV1_5->setSystemSelectionChannelsResponse_1_5(responseInfo);
    radioService[slotId]->checkReturnStatus(retStatus);
        
    }else if(radioService[slotId]->mRadioResponseV1_3 != NULL){
		RLOGD("zqy selectionChannelsResponse v1.3 ril_serice.cpp");
		Return<void> retStatus =
            radioService[slotId]->mRadioResponseV1_3->setSystemSelectionChannelsResponse(responseInfo);
    radioService[slotId]->checkReturnStatus(retStatus);
		return 0;
	}else{
		RLOGE("setSystemSelectionChannelsResponse: radioService[%d]->mRadioResponseV1_5 == NULL && "
                "radioService[%d]->mRadioResponseV1_3 == NULL", slotId, slotId);
	}
    ...
    for (int i = 0; i < num; i++) {
        ...
        switch(rillCellInfo->cellInfoType) {
            case RIL_CELL_INFO_TYPE_GSM: {
                ...
                cellInfoGsm->signalStrengthGsm.timingAdvance =
                        rillCellInfo->CellInfo.gsm.signalStrengthGsm.timingAdvance;
				RLOGE("convertRilCellInfoListToHal1 mcc = %s, mnc = %s", cellInfoGsm->cellIdentityGsm.mcc.c_str(), cellInfoGsm->cellIdentityGsm.mnc.c_str());
                break;
            }
            ...
            case RIL_CELL_INFO_TYPE_WCDMA: {
                ...
                cellInfoWcdma->signalStrengthWcdma.bitErrorRate =
                        rillCellInfo->CellInfo.wcdma.signalStrengthWcdma.bitErrorRate;
				RLOGE("convertRilCellInfoListToHal2 mcc = %s, mnc = %s", cellInfoWcdma->cellIdentityWcdma.mcc.c_str(), cellInfoWcdma->cellIdentityWcdma.mnc.c_str());
                break;
            }
            ...
            case RIL_CELL_INFO_TYPE_LTE: {
                ...
                cellInfoLte->signalStrengthLte.timingAdvance =
                        rillCellInfo->CellInfo.lte.signalStrengthLte.timingAdvance;
				RLOGE("convertRilCellInfoListToHal4 mcc = %s, mnc = %s", cellInfoLte->cellIdentityLte.mcc.c_str(), cellInfoLte->cellIdentityLte.mnc.c_str());
                break;
            }
            ...
            case RIL_CELL_INFO_TYPE_TD_SCDMA: {
				...
				RLOGE("convertRilCellInfoListToHal5 mcc = %s, mnc = %s", cellInfoTdscdma->cellIdentityTdscdma.mcc.c_str(), cellInfoTdscdma->cellIdentityTdscdma.mnc.c_str());
                break;
            }
            default: {
                break;
    ...
    for (int i = 0; i < num; i++) {
        ...
        switch(rillCellInfo->cellInfoType) {
            case RIL_CELL_INFO_TYPE_GSM: {
                ...
                cellInfoGsm.signalStrengthGsm.timingAdvance =
                        rillCellInfo->CellInfo.gsm.signalStrengthGsm.timingAdvance;
				RLOGE("convertRilCellInfoListToHal1 mcc = %s, mnc = %s",
					cellInfoGsm.cellIdentityGsm.base.base.mcc.c_str(), cellInfoGsm.cellIdentityGsm.base.base.mnc.c_str());
				records[i].ratSpecificInfo.gsm(std::move(cellInfoGsm));
                break;
            }
            ...
            case RIL_CELL_INFO_TYPE_WCDMA: {
                ...
                cellInfoWcdma.signalStrengthWcdma.base.bitErrorRate =
                        rillCellInfo->CellInfo.wcdma.signalStrengthWcdma.bitErrorRate;
				RLOGE("convertRilCellInfoListToHal2 mcc = %s, mnc = %s",
					cellInfoWcdma.cellIdentityWcdma.base.base.mcc.c_str(), cellInfoWcdma.cellIdentityWcdma.base.base.mnc.c_str());
				records[i].ratSpecificInfo.wcdma(std::move(cellInfoWcdma));
                break;
            }
            ...
            case RIL_CELL_INFO_TYPE_LTE: {
                ...
                cellInfoLte.cellIdentityLte.base.base.earfcn =
                        rillCellInfo->CellInfo.lte.cellIdentityLte.earfcn;
                cellInfoLte.cellIdentityLte.base.bandwidth = rillCellInfo->CellInfo.lte.cellIdentityLte.bandwidth;
                if (rillCellInfo->CellInfo.lte.cellIdentityLte.band > 0 && rillCellInfo->CellInfo.lte.cellIdentityLte.band < INT_MAX) {
                    cellInfoLte.cellIdentityLte.bands.resize(1);
                    cellInfoLte.cellIdentityLte.bands[0] = static_cast<V1_5::EutranBands>(rillCellInfo->CellInfo.lte.cellIdentityLte.band);
                    RLOGE("%s band = %d", __FUNCTION__, cellInfoLte.cellIdentityLte.bands[0]);
                ...
                cellInfoLte.signalStrengthLte.timingAdvance =
                        rillCellInfo->CellInfo.lte.signalStrengthLte.timingAdvance;
				RLOGE("convertRilCellInfoListToHal4 mcc = %s, mnc = %s, rssi = %d, rsrp = %d, rsrq = %d, rssnr = %d",
					cellInfoLte.cellIdentityLte.base.base.mcc.c_str(), cellInfoLte.cellIdentityLte.base.base.mnc.c_str(),
					 cellInfoLte.signalStrengthLte.signalStrength,
					 cellInfoLte.signalStrengthLte.rsrp,
					 cellInfoLte.signalStrengthLte.rsrq,
					 cellInfoLte.signalStrengthLte.rssnr);
            ...
            case RIL_CELL_INFO_TYPE_TD_SCDMA: {
                ...
                cellInfoTdscdma.cellIdentityTdscdma.base.base.mcc =
                        ril::util::mcc::decode(
                                rillCellInfo->CellInfo.tdscdma.cellIdentityTdscdma.mcc);
                cellInfoTdscdma.cellIdentityTdscdma.base.base.mnc =
                        ril::util::mnc::decode(
                                rillCellInfo->CellInfo.tdscdma.cellIdentityTdscdma.mnc);
                ...
                cellInfoTdscdma.signalStrengthTdscdma.rscp =
                        rillCellInfo->CellInfo.tdscdma.signalStrengthTdscdma.rscp;
				RLOGE("convertRilCellInfoListToHal5 mcc = %s, mnc = %s",
					cellInfoTdscdma.cellIdentityTdscdma.base.base.mcc.c_str(), cellInfoTdscdma.cellIdentityTdscdma.base.base.mnc.c_str());
				records[i].ratSpecificInfo.tdscdma(std::move(cellInfoTdscdma));
                break;
            }
            default: {
...
void radio::registerService(RIL_RadioFunctions *callbacks, CommandInfo *commands) {
    ...
    for (int i = 0; i < simCount; i++) {
        ...
        RLOGD("registerService: starting android::hardware::radio::V1_5::IRadio %s",
                serviceNames[i]);
