#ifndef __MEIG_LOG_H__
#define __MEIG_LOG_H__
#ifdef USE_NDK
...
#endif
#ifndef RLOGD
/*[zhaopengfei@meigsmart-2021-008-19] diable debug log by prop {*/
#define RLOGD(fmt, arg...) do { \
extern int debug_enable; \
if(debug_enable) \
(void)__android_log_buf_print(LOG_ID_RADIO, ANDROID_LOG_DEBUG, LOG_TAG, fmt, ##arg); \
}while(0);
/*[zhaopengfei@meigsmart-2021-008-19] diable debug log by prop }*/
#endif
#ifndef RLOGI
